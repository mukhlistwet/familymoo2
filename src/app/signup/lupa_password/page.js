        ...
        <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto lg:py-0">
          ...
          >
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              <h1 className="text-xl font-sans font-bold leading-tight tracking-tight text-cyan-700 md:text-3xl dark:text-white">Lupa Kata Sandi</h1>
              ...
              <form className="max-w-md mx-auto">
                ...
                <p id="helper-text-explanation" className="text-center mt-2  text-gray-500 dark:text-gray-400">
                  {" "}
                  <a href="/signup/masukan_password" className="text-cyan-900 font-sans font-medium hover:text-blue-600 dark:text-blue-500">
                    Kembali
                  </a>
                </p>
                <button
