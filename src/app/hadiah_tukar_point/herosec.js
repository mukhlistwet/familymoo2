...
function ImageComponent() {
  return (
    // <section className="relative w-full bg-gradient-to-r from-blue-500 to-blue-200 h-[300px] max-sm:h-[300px]">
    //   <img
    //     loading="lazy"
    ...
    //     className="object-contain w-full aspect-[2.56] absolute bottom-0 max-sm:bottom-0"
    //   />
    // </section>
