...
import PointsCard from "./herosec/PointsCard";
import Header from "./herosec/Header";
...
function ImageComponent() {
  return (
    <section className="relative w-full bg-gradient-to-r from-blue-500 to-blue-200 h-[500px] flex flex-col max-sm:justify-end lg:h-auto">
      ...
      />
      <div className="absolute z-0 flex flex-col justify-center w-[586px] max-w-full h-[316px] min-h-[216px] left-[200px] top-[143px] max-lg:left-[100px] max-md:left-[50px] max-sm:left-0 max-sm:top-[120px] max-sm:w-full max-sm:px-4 max-sm:h-auto">
        <div className="flex flex-col w-full max-md:max-w-full px-4">
          ...
          <p className="mt-3 text-xl text-sky-900 max-md:max-w-full max-md:text-justify max-md:text-base mb-2">Lorem ipsum dolor sit amet consectetur Sit purus</p>
        </div>
        <PointsCard />
      </div>
    </section>
